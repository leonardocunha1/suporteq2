                  ...
                  itens: [
                    <div className="space-y-2 w-full">
                      ...
                      <p>
                        ...
                        resultado mostrará as transações que têm divergência de
                        valores.
                      </p>
                      <p>
                        <span className="text-red-500 font-semibold">Obs.</span>{" "}
                        Os gateways e os valores devem estar na mesma
                        ordem/index. Por exemplo: se, no financeiro, uma
                        transação X tiver um valor de 10 reais e uma transação Y
                        tiver um valor de 20 reais, nos inputs terá que ficar
                        dessa forma: X, Y nos{" "}
